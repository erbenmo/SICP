	...
	((compound-procedure? procedure)
	 (eval-sequence
	  ...
	  (extend-environment
	   ...
	   (list-of-delayed-args arguments env) ;; delayed
...
;;  (display "list-of-arg-values -- actual") (newline)
  (if (no-operands? exps)
      '()
...
;;  (display "list-of-delayed-args -- actual") (newline)
  (if (no-operands? exps)
      '()
